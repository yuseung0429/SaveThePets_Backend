...
//	@Test
//	void contextLoads() {
////		String code = "vvKGW0uoJmokAH0aX1raZcHJoNVrMFqueRsVqpF6NMZPLcftYWsxVpErF0yjT8h0q9BI6wopyNkAAAGIlh_RSw";
////		System.out.println(authService.kakaoLogin(code));
////		Utilities.testGetUserInfo(userService, "yuseung0429@naver.com");
////		//북마크 생성하기
...
//		File newFile = new File("src\\main\\java\\com\\savethepets\\service\\AlarmService.java");
//		System.out.println(awsService.save(newFile, "posts"));
//
//	}
//}